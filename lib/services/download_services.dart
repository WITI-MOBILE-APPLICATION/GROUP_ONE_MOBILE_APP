...
class DownloadServices {
  ...
  Future<void> downloadMovie(String movieId, String title, String url, String thumbnailUrl) async {
    try {
      if (kIsWeb) {
        ...
        String fileExtension = url.endsWith('.jpg') || url.endsWith('.jpeg') ? '.jpg' : '.mp4';
  ...
  Future<void> saveToDownloadsDB(String movieId, String title, String filePath, String thumbnailUrl) async {
    try {
      ...
      downloads.add({
        'id': movieId,
        'title': title,
        'path': filePath, // On web, this will be the URL; on non-web, this will be the file path
